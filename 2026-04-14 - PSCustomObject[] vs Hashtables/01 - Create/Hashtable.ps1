...
# Adding values
$ht.Add('Event', 'PowerShell Summit 2026')
$ht.Add('Date', '2026-04-14')
...
# Or inline
$ht = @{ Event = 'PowerShell Summit 2026'; Date = '2026-04-14'; Location = 'Bellevue, WA' }
$ht
...
# Array of hashtables
$arrayOfHts = 2026..2031 | ForEach-Object {
    @{
